...
<body background="./img/fondo.jpg!d" class="body">
    <nav class="navbar navbar-expand-lg navbar-light " style="background-color:  #fbfbe5 ;">
        ...
        <button style="top:1%; left:96%;" type="submit" class="btn btn-primary cargar-chat" data-toggle="collapse" data-target="#demo"><i class="fa fa-comments" aria-hidden="true"></i></button>
        <div id="demo" class="collapse">
            <div class="chat">
                ...
                <div class="message-box">
                    <textarea type="text" class="message-input" id="message" placeholder=""></textarea>
